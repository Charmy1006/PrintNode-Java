...
public class CreatingAnAccount{
	public static void main(String args[]) throws IOException{
		...
		CreateAccountJson accountInfo = new CreateAccountJson("Arjun","Patel","arjun123@orderhive123.com","pwd@orderhive");
		...
		System.out.println("Account Obj: "+ accountObject.toString());
