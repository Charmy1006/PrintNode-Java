...
public class Options {
	...
	public Options(String paper, String dpi, int copies, int rotate) {
		setPaper(paper);
		setDpi(dpi);
		setCopies(copies);
		setRotate(rotate);
	...
	/**
	 * @param newCollate
	 *            Set whether we want to collate.
	 */
	...
	/**
	 * @param newCopies
	 *            Set the amount of copies we want to print.
	 */
	...
	/**
	 * @param newFitToPage
	 *            set whether we want to fit the content to the page.
	 */
	...
	/**
	 * @param newNup
	 *            Set number of pages to print per page for a compact layout
	 *            printing.
	 */
	...
	/**
	 * @param newRotate
	 *            set rotation. Can only be 90,180 or 270.
	 */
